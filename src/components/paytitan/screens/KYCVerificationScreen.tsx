              ...
              {hasKYC ? (
                <>
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-[#1A2130]/60">Your virtual accounts are fully set up and ready for use.</p>
                  </div>

                  <div className="bg-white dark:bg-white/5 border border-indigo-500/10 p-4 rounded-2xl space-y-3 shadow-sm">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-indigo-500/10 flex items-center justify-center shrink-0">
                        <ShieldCheck className="w-4 h-4 text-indigo-500" />
                      </div>
                      <div>
                        <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest leading-none mb-1">COMPLIANCE SIGNUP DATA</p>
                        <p className="text-xs font-bold text-[#1A2130] dark:text-white">
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex justify-between items-center">
                        <span className="text-[10px] text-muted-foreground font-semibold uppercase tracking-widest">Settlement Bank</span>
                        <span className="text-xs font-bold text-[#1A2130] dark:text-white">Titan Trust Bank</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-[10px] text-muted-foreground font-semibold uppercase tracking-widest">Account Number</span>
                        <span className="text-sm font-mono font-bold tracking-wider text-[#FF4D1C] tabular-nums">
                          {profile?.bvn 
