...
export default function AdminSettings() {
  ...
  const [monnifyStatus, setMonnifyStatus] = useState<'Healthy' | 'Degraded' | 'Offline' | 'Checking'>('Checking');
        ...
        <>
          <div className="bg-card border border-border shadow-sm rounded-[24px] p-6">
            <div className="flex justify-between items-center mb-6 border-b border-border pb-4">
              <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-widest">Partners & APIs</h3>
              <button onClick={() => { setMonnifyStatus('Checking'); setSupabaseStatus('Checking'); checkHealth(); }} className="text-xs font-bold text-indigo-500">Refresh</button>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-border pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-[15px] text-foreground tracking-tight">Monnify</p>
                    <p className="text-[12px] text-muted-foreground">Primary Virtual Accounts</p>
                  </div>
                </div>
                <StatusBadge status={monnifyStatus} />
              </div>
