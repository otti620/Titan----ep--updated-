...
import { Home, Users2, User, LayoutGrid, PiggyBank, History, Zap, Loader2, WifiOff, ShieldCheck } from 'lucide-react';
  ...
  return (
    ...
    >
          ...
          {showAdmin ? (
            ...
            >
              <div className="pb-32 min-h-full">
                ...
                {activeTab === 'history' && <TransactionHistoryScreen onBack={() => setActiveTab('home')} onSelectTransaction={(id) => setDrawerScreen(`tx-${id}`)} />}
      ...
      <ActionDrawer 
        ...
        fullScreen={['titan-ai', 'titan-nearby', 'transfer', 'bank-transfer', 'request-money', 'history', 'topup', 'airtime', 'data', 'notifications', 'qr-code', 'edit-profile', 'kyc', 'support', 'referral', 'security', 'subscriptions', 'create-circle', 'join-circle', 'tribe-hub', 'bills', 'cable-tv', 'electricity', 'limits', 'month-recap', 'year-recap', 'contacts', 'legal'].includes(drawerScreen || '')}
      >
